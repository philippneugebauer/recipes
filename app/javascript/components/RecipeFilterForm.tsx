  ...
  return (
    <form onSubmit={submitHandler} className="mt-4 mb-1">
      <div className="input-group">
        <input value={filterByIngredients} onChange={changeHandler} type="text" name="filter_by_ingredients" className="form-control" aria-label="ingredient filter input" describedby="submit-filter" />
