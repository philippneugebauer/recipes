  ...
  return (
    <form onSubmit={submitHandler} className="mt-4 mb-1">
      <div className="input-group">
        <input value={filterByIngredients} onChange={changeHandler} type="text" className="form-control border-end-0" name="filter_by_ingredients" aria-label="ingredient filter input" aria-describedby="submit-filter" />
